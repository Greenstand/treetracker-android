...
val MIGRATION_6_7 =
    object : Migration(6, 7) {
        override fun migrate(database: SupportSQLiteDatabase) {
            val sql =
                """CREATE INDEX `index_planter_check_in_local_photo_path`
...
val MIGRATION_4_5 =
    object : Migration(4, 5) {
        override fun migrate(database: SupportSQLiteDatabase) {
            val sql =
                """ALTER TABLE ${PlanterInfoEntity.TABLE}
    ...
    object : Migration(3, 4) {
        override fun migrate(database: SupportSQLiteDatabase) {
            try {
                ...
                val createPlanterCheckIn =
                    """CREATE TABLE IF NOT EXISTS `planter_check_in` (
                | `_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                ...
                val createIndexPlanterInfo =
                    """CREATE INDEX IF NOT EXISTS
                |`index_planter_check_in_planter_info_id`
                | ON `planter_check_in` (`planter_info_id`)
                    """.trimMargin()
                database.execSQL(createIndexPlanterInfo)

                val createTreeCapture =
                    """CREATE TABLE IF NOT EXISTS `tree_capture` (
                | `_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
                | `uuid` TEXT NOT NULL,
                ...
                val createPlanterCheckInUploadIndex =
                    """CREATE INDEX IF NOT EXISTS
                ...
                val populatePlanterInfoEntity =
                    """INSERT INTO `planter_info` (
                ...
                val populatePlanterCheckIns =
                    """INSERT INTO `planter_check_in` (
            ...
            | 
                ...
                val populateTreeCaptures =
                    """INSERT INTO `tree_capture` (`_id`, `uuid`,
            ...
            | 
                ...
                val populateTreeAttributes =
                    """INSERT INTO `tree_attribute` (

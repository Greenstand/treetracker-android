...
public class DigitalOceanSpaces {

    public static final String ENDPOINT = "https://nyc3.digitaloceanspaces.com";
    public static final String BUCKET = "my-bucket";

    private static DigitalOceanSpaces sInstance;
    private AmazonS3 s3Client;

    public static DigitalOceanSpaces instance() {
        if (sInstance == null) {
            sInstance = new DigitalOceanSpaces();
        }
        return sInstance;
    }

    private DigitalOceanSpaces() {

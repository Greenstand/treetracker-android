...
class MigrationV1ToV2 : Migration(1, 2) {
    ...
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL(
            "INSERT INTO new_tree(_id,main_db_id, time_created, time_updated, time_for_update, three_digit_number, location_id, is_missing, is_synced, is_priority, cause_of_death_id, settings_id, settings_override_id, user_id, planter_identification_id) \n" +
                    "SELECT \"_id\", main_db_id, time_created, time_updated, time_for_update, three_digit_number, location_id,\n" +
                    "CASE WHEN (is_missing = 'N') THEN 0 ELSE 1 END,\n" +
                    "CASE WHEN (is_synced like 'N') THEN 0 ELSE 1 END,\n" +
                    "CASE WHEN (is_priority like 'N') THEN 0 ELSE 1 END,\n" +
                    "cause_of_death_id, settings_id, settings_override_id, user_id, planter_identification_id\n" +
                    "FROM tree"
        )
        ...
        database.execSQL(
            "INSERT INTO new_planter_details\n" +
                    "(\"_id\",identifier, first_name, last_name, organization, phone, email, uploaded, time_created)\n" +
                    "SELECT \"_id\", identifier, first_name, last_name, organization, phone, email, CASE WHEN (uploaded = 'N') THEN 0 ELSE 1 END, time_created\n" +
                    "FROM planter_details"
        )
        ...
        database.execSQL(
            "INSERT INTO new_photo\n" +
                    "(_id,name, location_id, main_db_id, is_outdated, time_taken, user_id)\n" +
                    "SELECT \"_id\",name, main_db_id,location_id, CASE WHEN (is_outdated = 'N') THEN 0 ELSE 1 END, time_taken,  user_id \n" +
                    "FROM photo"
        )
        ...
        database.execSQL(
            "INSERT INTO new_tree_note\n" +
                    "(note_id, tree_id)\n" +
                    "SELECT note_id,tree_id \n" +
                    "FROM tree_note"
        )
        ...
        database.execSQL(
            "INSERT INTO new_tree_photo\n" +
                    "(photo_id, tree_id)\n" +
                    "SELECT photo_id,tree_id \n" +
                    "FROM tree_photo"
        )
        ...
        database.execSQL(
            "INSERT INTO new_location\n" +
                    ...
                    "SELECT \"_id\", accuracy, lat, long,  user_id,main_db_id\n" +
                    "FROM location"
        )
        ...
        database.execSQL(
            "INSERT INTO new_planter_identifications\n" +
                    "(_id,planter_details_id, identifier, photo_path, photo_url, time_created)\n" +
                    "SELECT \"_id\", planter_details_id, identifier, photo_path, photo_url, time_created\n" +
        ...
        database.execSQL(
            "INSERT INTO new_settings\n" +
                    "(_id,main_db_id, time_to_next_update, min_accuracy)\n" +
                    "SELECT \"_id\", main_db_id, time_to_next_update, min_accuracy\n" +
                    "FROM settings"
        )
        ...
        database.execSQL(
            "INSERT INTO new_pending_updates\n" +
                    "(_id,main_db_id, user_id, settings_id, tree_id, location_id, radius)\n" +
                    "SELECT \"_id\", main_db_id, user_id, settings_id, tree_id, location_id, radius\n" +

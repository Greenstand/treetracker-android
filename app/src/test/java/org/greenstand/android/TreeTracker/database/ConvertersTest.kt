...
class ConvertersTest {
    @Test
    fun `WHEN jsonToMap and mapToJson called THEN round-trip correctly`() =
        runTest {
    ...
    @Test
    fun `WHEN jsonToMap receives null THEN returns null`() =
        runTest {
    ...
    @Test
    fun `WHEN mapToJson receives null THEN returns null`() =
        runTest {
    ...
    @Test
    fun `WHEN instantToString called THEN converts Instant to ISO string`() =
        runTest {
    ...
    @Test
    fun `WHEN stringToInstance called THEN converts ISO string to Instant`() =
        runTest {
    ...
    @Test
    fun `WHEN instantToString receives null THEN returns null`() =
        runTest {
    ...
    @Test
    fun `WHEN stringToArray and arrayToString called THEN round-trip correctly`() =
        runTest {
    ...
    @Test
    fun `WHEN stringToArray receives null THEN returns null`() =
        runTest {
